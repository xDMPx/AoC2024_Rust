...
mod tests {
    ...
    fn test_example_input() {
        ...
        let day10_part2 = aoc2024::day10::part02("./test_puzzle_input/day10_test.txt");
        assert_eq!(day10_part2, 81);

        let day11_part1 = aoc2024::day11::part01("./test_puzzle_input/day11_test.txt");
        assert_eq!(day11_part1, 55312);
        let day11_part2 = aoc2024::day11::part02("./test_puzzle_input/day11_test.txt");
        assert_eq!(day11_part2, 65601038650482);

        let day12_part1 = aoc2024::day12::part01("./test_puzzle_input/day12_test.txt");
        assert_eq!(day12_part1, 1930);
        let day12_part2 = aoc2024::day12::part02("./test_puzzle_input/day12_test.txt");
        assert_eq!(day12_part2, 1206);

        let day13_part1 = aoc2024::day13::part01("./test_puzzle_input/day13_test.txt");
        assert_eq!(day13_part1, 480 + 1);
    }
}
